...
const SideBar = (props: Props) => {
  ...
  return (
    <Fragment>
<nav className="sticky top-0 z-50 w-full border-b bg-gray-800 border-gray-200">
    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center justify-start rtl:justify-end">
        ...
        <a href="https://flowbite.com" className="flex ms-2 md:me-24">
          <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Customer Data</span>
        </a>
      </div>
